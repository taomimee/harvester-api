...
<div className="bg-gradient-to-r from-emerald-800 via-green-700 to-teal-900 py-3.5 px-4 rounded-2xl shadow-lg mb-3 text-center relative overflow-hidden">
  <div className="relative z-10 flex flex-col items-center">
    ...
    <div className="relative mb-1">
      ...
      {/* 🐘 3. ไอคอนช้างขาว SVG (ช้างแท้ 100% มีงวง มีงาชัดเจน ไม่กลายร่างแน่นอน) */}
<div className="relative inline-flex items-center justify-center w-12 h-12 bg-black/20 backdrop-blur-md rounded-xl shadow-inner border border-amber-300/40">
  ...
  >
    <path d="M512 119.3V144c0 30.6-13.4 59.4-36.6 79l-4.5 3.8-3.3-5.5c-15.6-25.6-43.2-41.3-73.4-41.3H384v-32c0-53-43-96-96-96H224C100.3 52 0 152.3 0 276v68c0 15.1 9.5 28.5 23.7 32.8l40.3 12.1v23.2C64 456.3 99.7 492 144 492h16c17.7 0 32-14.3 32-32v-92h96v92c0 17.7 14.3 32 32 32h16c44.3 0 80-35.7 80-80v-40.4l30.4-15.2c35.6-17.8 57.6-53.7 57.6-93.5V119.3c0-12.8-15.3-19.4-24.6-10.6l-67.4 64.7z"></path>
  </svg>
</div>
    </div>
